...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.example.mybanktsf.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.example.mybanktsf.ViewHolder.ClickListener clickListener){
